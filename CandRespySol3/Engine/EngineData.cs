...
namespace CandRespySol.Engine
{
    class EngineData
    {
        ...
        public const string Extension = ".aglr";
        public const string ExtensionFile = "aglr";
        public const string FiltroFile = " | *.aglr";
        ...
        public const string Titulo = "3.- Candidatos - Respuesta y Solución";
