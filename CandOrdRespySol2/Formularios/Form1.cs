...
namespace CandOrdRespySol
{
    public partial class Form1 : Form
    {
        ...
        private void AplicarIdioma()
        {
            ...
            {
                this.Text = CandOrdRespySol2.RecursosLocalizables.StringResources.thisText;
            }
           else
            {
                this.Text = CandOrdRespySol2.RecursosLocalizables.StringResources.thisText + " : " + Funcion.NombreJuego(pathArchivo);
            }
            mIdiomas.Text = CandOrdRespySol2.RecursosLocalizables.StringResources.mIdiomas;
            mIEspañol.Text = CandOrdRespySol2.RecursosLocalizables.StringResources.mIEspañol;
            mIIngles.Text = CandOrdRespySol2.RecursosLocalizables.StringResources.mIIngles;
            mIPortugues.Text = CandOrdRespySol2.RecursosLocalizables.StringResources.mIPortugues;
            mRS.Text = CandOrdRespySol2.RecursosLocalizables.StringResources.mRS;
            mIAbrir.Text = CandOrdRespySol2.RecursosLocalizables.StringResources.mIAbrir;
            mIComparar.Text = CandOrdRespySol2.RecursosLocalizables.StringResources.mIComparar;
