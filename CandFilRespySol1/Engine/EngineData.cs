...
namespace CandFilRespySol.Engine
{
    class EngineData
    {
        ...
        public const string ClaveRegWin = "CandFilRespySol1";
        ...
        public const string ArchivoEjecutable = "CandFilRespySol1.exe";
        public const string ProgramaId = "CandFilRespySol1";
