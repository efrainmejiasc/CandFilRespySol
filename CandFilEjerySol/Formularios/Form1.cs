    ...
    public partial class Form1 : Form
    {
        ...
        private void txt00_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    numActivo = Funcion.ValorIngresado(txtSudoku);
                    if (numActivo != "0")
                    {
                        if (!Funcion.ComparacionIngresado(txtSudoku, numActivo))
                        {
                            txt.Text = string.Empty;
                        }
                        else
       ...
       //**************************************************************************************************
        ...
        private string GuardarComoSaveDialog()
        {
            ...
            this.saveFileDialog1.Filter = "Archivos de Texto" + " | *.mflm"; 
            this.saveFileDialog1.Title = "Abrir Juego";
            this.saveFileDialog1.DefaultExt = ".mflm";
